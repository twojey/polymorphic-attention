...
Catalogue exhaustif : [`CATALOGUE.md`](CATALOGUE.md) (131 propriétés × 18 catégories A-V).
...
3. [`CATALOGUE.md`](CATALOGUE.md) § Propriétés — les 131 mesures  
...
**Version** : 2026-05-12 | **Consolidation** : 4 fichiers fusionnés en 1 point d'entrée
